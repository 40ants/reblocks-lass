# -*- coding: utf-8 -*-
#
# weblocks-lass documentation build configuration file, created by
...
htmlhelp_basename = 'weblocks-lassdoc'
...
latex_documents = [
  ('index', 'weblocks-lass.tex', u'weblocks-lass Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'weblocks-lass', u'weblocks-lass Documentation',
     [u''], 1)
]
